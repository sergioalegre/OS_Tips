...
### ROLES-SNAPS
  ...
  - estado de los servicios **service --status-all**
...
### ACTUALIZAR-VERSION
  ...
  - Ver distro y version: **cat /etc/issue**
...
### NETWORKING
  ...
  - poner ip estática (con **ip a** podemos ver el nombre de la interfaz):
...
### DISCOS-PARTICIONES
  ...
  - comprobar sistema de ficheros en el siguiente arranque: **touch /forcefsck && reboot**
